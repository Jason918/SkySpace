 ...
 *
 */
public class EnvItem extends EnvElement{
	...
	public EnvItem(ObjectProxy owner,int type,String tuple,int time){
		super(owner,time);
		this.type = type;
		this.tuple = tuple;
	}
	...
	@Override
	public EnvElement unpack(String pack) {//TODO check format
		return new EnvItem(pack);
	}
}
